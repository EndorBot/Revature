...
public class ArthimaticService {
	...
	public String doAddition(String number1String, String number2String) {
		...
		String result = "The sum of the two numbers are: " + sum; // Convert from double representation of a number to a
	...
	public String doSubtraction(String number1String, String number2String) {
		...
		String result = "The difference of the two numbers are: " + difference; // Convert from double representation of
	...
	public String doMultiplication(String number1String, String number2String) {
		...
		String result = "The product of the two numbers are: " + product; // Convert from double representation of a
	...
	public String doDivision(String number1String, String number2String) {
		...
		String result = "The quotient of the two numbers are: " + quotient; // Convert from double representation of a
																			// number to a String representation
